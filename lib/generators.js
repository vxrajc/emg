...
function initGenerator(pathx) {
    try {
        ...
        console.log("🚨 Password Required to install Nodemon globally.");
        execSync("sudo npm i -g nodemon", { stdio: "ignore" });
        console.log("✅ Nodemon installed successfully.");

        execSync("npm i dotenv", { stdio: "ignore" });
        ...
        const sourceFile2 = path.resolve(__dirname, "../init/db.js"); // Ensure this path is correct
        const destinationFile2 = path.resolve(pathx, "db.js");


        const sourceFile3 = path.resolve(__dirname, "../init/.env"); // Ensure this path is correct
        const destinationFile3 = path.resolve(pathx, ".env");
        ...
        fs.copyFile(sourceFile2, destinationFile2, (copyErr) => {
            console.log(copyErr);

            if (copyErr) {
                console.error("❌ Error copying file:", copyErr);
            } else {
                console.log("✅ File copied successfully to:", destinationFile2);
                console.log("✅ Created index.js");
            }
        });
        fs.copyFile(sourceFile3, destinationFile3, (copyErr) => {
            console.log(copyErr);

            if (copyErr) {
                console.error("❌ Error copying file:", copyErr);
            } else {
                console.log("✅ File copied successfully to:", destinationFile3);
                console.log("✅ Created index.js");
            }
        });
        console.log("✅ Created index.js");
...
function generateAuth(pathx) {
    var auth_data = [
        ...
        },
        {
            ...
            "dir": "middleware",
            "source": path.resolve(__dirname, "../auth/authMiddleware.js"),
            "destination": path.join(pathx, "middleware"),
            "destionationFile": path.join(path.join(pathx, "middleware"), "authMiddleware.js")
